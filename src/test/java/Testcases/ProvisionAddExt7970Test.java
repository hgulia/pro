...
public class ProvisionAddExt7970Test extends TestBase {
	...
	public void provisionAddExt7970(String huntpilot, String huntlistname, String linegroupname, String cucm,
			String cuc) throws InterruptedException, IOException {

		Actions action = new Actions(driver);

		WebElement jobsource = driver.findElement(By.xpath(OR.getProperty("7970job")));
		...
		type("7970phonedevice", "7910phone");
		...
		click("7970generatecode");

		Thread.sleep(4000);

		macid = driver.findElement(By.xpath(OR.getProperty("7970storecode"))).getAttribute("value");
		...
		if (errormsgdisplay == true) {
			...
			if (status.equals(expected)) {
				...
				Select selectdevice = new Select(driver.findElement(By.xpath(OR.getProperty("ciscodevice7970"))));
				...
				Select selectpro = new Select(driver.findElement(By.xpath(OR.getProperty("ciscoprofile7970"))));

				selectpro.selectByVisibleText("7910profile");

				WebElement optionpro = selectpro.getFirstSelectedOption();

				String deviceprofile = optionpro.getText();

				if (deviceprofile.equals("7910profile")) {
	...
	@Test(priority = 3)
	public void mainPageOpenDeleteExt7970() throws InterruptedException {
	...
	public void provisionDeleteExt7970(String huntpilot, String huntlistname, String linegroupname, String cucm,
			String cuc) throws InterruptedException, IOException {

		Actions action = new Actions(driver);

		WebElement jobsource = driver.findElement(By.xpath(OR.getProperty("7970jobdelete")));
