...
public class ProvisionCreateHuntListMoreAgainTest extends TestBase {

	@Test(priority = 1)
	public void mainPageOpenHuntListDouble() throws InterruptedException {
	...
	public void provisionHuntListDouble(String huntpilot, String huntlistname, String linegroupname, String cucm,
		...
		type("huntlistnameaddjob4", "TestHunt List For Forward LGM");
